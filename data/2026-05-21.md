...
### [31] [What Do Agents Communicate? Characterizing Information Exchange in Multi-Agent Systems](https://arxiv.org/abs/2605.20548)
...
### [35] [Artificial Pancreas Implantables -- How Healthcare Professionals May Deal With DIY Bio Cases](https://arxiv.org/abs/2605.20208)
...
### [36] [Pramana: A Protocol-Layer Treatment of Claim Verification in Autonomous Agent Networks](https://arxiv.org/abs/2605.20312)
...
### [37] [Adaptive Probe-based Steering for Robust LLM Jailbreaking](https://arxiv.org/abs/2605.20286)
...
### [39] [Security Document Classification with a Fine-Tuned Local Large Language Model: Benchmark Data and an Open-Source System](https://arxiv.org/abs/2605.20368)
*Ivan Dobrovolskyi*
...
### [40] [Latent Geometry as a Structural Monitor: Eigenspace Alignment for Anomaly Detection in Anonymity Networks](https://arxiv.org/abs/2605.20391)
*Vaibhav Chhabra*
...
### [41] [Detecting Data Exfiltration through I2P Anonymity Networks: A Two-Phase Machine Learning Approach](https://arxiv.org/abs/2605.20546)
...
### [42] [Trusted Weights, Treacherous Optimizations? Optimization-Triggered Backdoor Attacks on LLMs](https://arxiv.org/abs/2605.20641)
...
### [43] [Rethinking Fraud Safety Evaluation: Multi-Round Attacks Reveal Safety-Utility Tradeoffs in Graph-Context LLM Defenders](https://arxiv.org/abs/2605.20759)
...
### [44] [GenAI-Driven Threat Detection with Microsoft Security Copilot](https://arxiv.org/abs/2605.20896)
...
### [45] [An IoT-Enabled Smart Home Automation System for Energy Efficiency with Web-Based Control](https://arxiv.org/abs/2605.20981)
...
### [46] [Domijn: The Security of Domain Registrars and the Risk of a Domain Name Takeover](https://arxiv.org/abs/2605.20984)
...
### [47] [Verifiable Provenance and Watermarking for Generative AI: An Evidentiary Framework for International Operational Law and Domestic Courts](https://arxiv.org/abs/2605.21002)
...
### [48] [An Evidence-driven Protocol for Trustworthy CI Pipelines](https://arxiv.org/abs/2605.21089)
...
### [49] [Image Encryption via Data-Identified Discrete Chaotic Maps](https://arxiv.org/abs/2605.21118)
...
### [50] [Detecting Trojaned DNNs via Spectral Regression Analysis](https://arxiv.org/abs/2605.21146)
...
### [51] [Information Leakage Envelopes](https://arxiv.org/abs/2605.21185)
...
### [52] [Profiling User Vulnerability to Phishing Through Psychological and Behavioral Factors](https://arxiv.org/abs/2605.21246)
...
### [53] [Onion-Routed Multi-Circuit Key Establishment for Quantum-Resilient Sessions](https://arxiv.org/abs/2605.21349)
...
### [54] [Auditing Apple's DifferentialPrivacy.framework: Implementation Bugs, Misconfigurations, and Practical Risks](https://arxiv.org/abs/2605.21378)
...
### [55] [VIPER-MCP: Detecting and Exploiting Taint-Style Vulnerabilities in Model Context Protocol Servers](https://arxiv.org/abs/2605.21392)
