...
### [2] [Causal Foundations of Collective Agency](https://arxiv.org/abs/2605.00248)
...
### [18] [Ambient Persuasion in a Deployed AI Agent: Unauthorized Escalation Following Routine Non-Adversarial Content Exposure](https://arxiv.org/abs/2605.00055)
...
### [19] [Symbolic Execution Meets Multi-LLM Orchestration: Detecting Memory Vulnerabilities in Incomplete Rust CVE Snippets](https://arxiv.org/abs/2605.00034)
...
### [20] [Compliance-Aware Agentic Payments on Stablecoin Rails](https://arxiv.org/abs/2605.00071)
...
### [21] [Lightweight Tamper-Evident Log Integrity Verification for IoT Edge Environments: A Merkle Tree Pipeline with Adaptive Chunking](https://arxiv.org/abs/2605.00065)
...
### [22] [Skills as Verifiable Artifacts: A Trust Schema and a Biconditional Correctness Criterion for Human-in-the-Loop Agent Runtimes](https://arxiv.org/abs/2605.00424)
*Alfredo Metere*
...
### [23] [XekRung Technical Report](https://arxiv.org/abs/2605.00072)
...
### [24] [zkSBOM: Privacy-Preserving SBOM Sharing with Zero-Knowledge Sets](https://arxiv.org/abs/2605.00076)
...
### [25] [Alignment Contracts for Agentic Security Systems](https://arxiv.org/abs/2605.00081)
...
### [26] [I can't recognize (yet): Delayed Rendering to Defeat Visual Phishing Detectors](https://arxiv.org/abs/2605.00183)
...
### [27] [Selfie-Capture Dynamics as an Auxiliary Signal Against Deepfakes and Injection Attacks for Mobile Identity Verification](https://arxiv.org/abs/2605.00218)
...
### [28] [Attention Is Where You Attack](https://arxiv.org/abs/2605.00236)
...
### [29] [A Comparative Analysis of Machine Learning Models for Intrusion Detection in Intelligent Transport Systems](https://arxiv.org/abs/2605.00279)
...
### [30] [A Privacy-Preserving Approach to Conformance Checking](https://arxiv.org/abs/2605.00283)
...
### [31] [Trident: Improving Malware Detection with LLMs and Behavioral Features](https://arxiv.org/abs/2605.00297)
...
### [32] [Semia: Auditing Agent Skills via Constraint-Guided Representation Synthesis](https://arxiv.org/abs/2605.00314)
...
### [33] [Block-wise Codeword Embedding for Reliable Multi-bit Text Watermarking](https://arxiv.org/abs/2605.00348)
...
### [34] [CleanBase: Detecting Malicious Documents in RAG Knowledge Databases](https://arxiv.org/abs/2605.00460)
...
### [35] [Zero-Knowledge Model Checking](https://arxiv.org/abs/2605.00487)
...
### [36] [Pick and Sort for Graphical Authentication](https://arxiv.org/abs/2605.00558)
...
### [37] [KingsGuard: Enclave Data Protection Under Real-World TEE Vulnerabilities](https://arxiv.org/abs/2605.00613)
...
### [38] [Defense against Poisoning Attacks under Shuffle-DP](https://arxiv.org/abs/2605.00625)
...
### [39] [STARE: Step-wise Temporal Alignment and Red-teaming Engine for Multi-modal Toxicity Attack](https://arxiv.org/abs/2605.00699)
...
### [40] [Self-Adaptive Multi-Agent LLM-Based Security Pattern Selection for IoT Systems](https://arxiv.org/abs/2605.00741)
...
### [41] [Repurposing Image Diffusion Models for Adversarial Synthetic Structured Data: A Case Study of Ground Truth Drift](https://arxiv.org/abs/2605.00788)
...
### [42] [When RAG Chatbots Expose Their Backend: An Anonymized Case Study of Privacy and Security Risks in Patient-Facing Medical AI](https://arxiv.org/abs/2605.00796)
...
### [43] [The $\textit{Silicon Society}$ Cookbook: Design Space of LLM-based Social Simulations](https://arxiv.org/abs/2605.00197)
...
### [44] [Foresight Arena: An On-Chain Benchmark for Evaluating AI Forecasting Agents](https://arxiv.org/abs/2605.00420)
...
### [45] [Learning to Act and Cooperate for Distributed Black-Box Consensus Optimization](https://arxiv.org/abs/2605.00691)
