...
### [16] [LLMGreenRec: LLM-Based Multi-Agent Recommender System for Sustainable E-Commerce](https://arxiv.org/abs/2603.11025)
...
### [17] [Evaluating Generalization Mechanisms in Autonomous Cyber Attack Agents](https://arxiv.org/abs/2603.10041)
...
### [18] [Targeted Bit-Flip Attacks on LLM-Based Agents](https://arxiv.org/abs/2603.10042)
...
### [19] [OAuthHub: Mitigating OAuth Data Overaccess through a Local Data Hub](https://arxiv.org/abs/2603.10056)
...
### [20] [SBOMs into Agentic AIBOMs: Schema Extensions, Agentic Orchestration, and Reproducibility Evaluation](https://arxiv.org/abs/2603.10057)
...
### [21] [Tool Receipts, Not Zero-Knowledge Proofs: Practical Hallucination Detection for AI Agents](https://arxiv.org/abs/2603.10060)
*Abhinaba Basu*
...
### [22] [Building Privacy-and-Security-Focused Federated Learning Infrastructure for Global Multi-Centre Healthcare Research](https://arxiv.org/abs/2603.10063)
...
### [23] [ADVERSA: Measuring Multi-Turn Guardrail Degradation and Judge Reliability in Large Language Models](https://arxiv.org/abs/2603.10068)
...
### [24] [Why LLMs Fail: A Failure Analysis and Partial Success Measurement for Automated Security Patch Generation](https://arxiv.org/abs/2603.10072)
*Amir Al-Maamari*
...
### [25] [TASER: Task-Aware Spectral Energy Refine for Backdoor Suppression in UAV Swarms Decentralized Federated Learning](https://arxiv.org/abs/2603.10075)
...
### [26] [Amnesia: Adversarial Semantic Layer Specific Activation Steering in Large Language Models](https://arxiv.org/abs/2603.10080)
...
### [27] [Multi-Stream Perturbation Attack: Breaking Safety Alignment of Thinking LLMs Through Concurrent Task Interference](https://arxiv.org/abs/2603.10091)
*Fan Yang*
...
### [28] [Detecting Privilege Escalation with Temporal Braid Groups](https://arxiv.org/abs/2603.10094)
*Christophe Parisel*
...
### [29] [Compatibility at a Cost: Systematic Discovery and Exploitation of MCP Clause-Compliance Vulnerabilities](https://arxiv.org/abs/2603.10163)
...
### [30] [MCP-in-SoS: Risk assessment framework for open-source MCP servers](https://arxiv.org/abs/2603.10194)
...
### [31] [Paladin: A Policy Framework for Securing Cloud APIs by Combining Application Context with Generative AI](https://arxiv.org/abs/2603.10228)
...
### [32] [ACE Runtime - A ZKP-Native Blockchain Runtime with Sub-Second Cryptographic Finality](https://arxiv.org/abs/2603.10242)
*Jian Sheng Wang*
...
### [33] [Post-Quantum Entropy as a Service for Embedded Systems](https://arxiv.org/abs/2603.10274)
...
### [34] [PRoADS: Provably Secure and Robust Audio Diffusion Steganography with latent optimization and backward Euler Inversion](https://arxiv.org/abs/2603.10314)
...
### [35] [The Orthogonal Vulnerabilities of Generative AI Watermarks: A Comparative Empirical Benchmark of Spatial and Latent Provenance](https://arxiv.org/abs/2603.10323)
...
### [36] [Don't Let the Claw Grip Your Hand: A Security Analysis and Defense Framework for OpenClaw](https://arxiv.org/abs/2603.10387)
...
### [37] [Naïve Exposure of Generative AI Capabilities Undermines Deepfake Detection](https://arxiv.org/abs/2603.10504)
...
### [38] [An Approach for Safe and Secure Software Protection Supported by Symbolic Execution](https://arxiv.org/abs/2603.10608)
...
### [39] [Detecting and Eliminating Neural Network Backdoors Through Active Paths with Application to Intrusion Detection](https://arxiv.org/abs/2603.10641)
...
### [40] [Repurposing Backdoors for Good: Ephemeral Intrinsic Proofs for Verifiable Aggregation in Cross-silo Federated Learning](https://arxiv.org/abs/2603.10692)
...
### [41] [CacheSolidarity: Preventing Prefix Caching Side Channels in Multi-tenant LLM Serving Systems](https://arxiv.org/abs/2603.10726)
...
### [42] [AttriGuard: Defeating Indirect Prompt Injection in LLM Agents via Causal Attribution of Tool Invocations](https://arxiv.org/abs/2603.10749)
...
### [43] [A PUF-Based Approach for Copy Protection of Intellectual Property in Neural Network Models](https://arxiv.org/abs/2603.10753)
...
### [44] [Incremental Federated Learning for Intrusion Detection in IoT Networks under Evolving Threat Landscape](https://arxiv.org/abs/2603.10776)
...
### [45] [Re-Evaluating EVMBench: Are AI Agents Ready for Smart Contract Security?](https://arxiv.org/abs/2603.10795)
...
### [46] [MAD: Memory Allocation meets Software Diversity](https://arxiv.org/abs/2603.10840)
...
### [47] [Layered Performance Analysis of TLS 1.3 Handshakes: Classical, Hybrid, and Pure Post-Quantum Key Exchange](https://arxiv.org/abs/2603.11006)
...
### [48] [Separating Oblivious and Adaptive Differential Privacy under Continual Observation](https://arxiv.org/abs/2603.11029)
