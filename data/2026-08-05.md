...
### [126] [Micro-Segmentation Anomaly Detection in Zero-Trust Software-Defined Network Fabrics](https://arxiv.org/abs/2608.02627)
*Ashly Joseph*
...
### [127] [Secure AI Watermarking Framework for IP Protection in Multi-Tenant Cloud Platforms](https://arxiv.org/abs/2608.02656)
...
### [128] [Your Agentic LLMs Secretly Encode Latent Signals of Indirect Prompt-Injection Exposure](https://arxiv.org/abs/2608.02657)
...
### [129] [ZK-SR117: A Chunked Zero-Knowledge Attestation Design for Aggregated Fair-Lending Metrics, with a Control Mapping toward Full SR 11-7 Coverage](https://arxiv.org/abs/2608.02664)
...
### [130] [Single Canonical Prompts Underestimate LLM Safety's Surface-Form Sensitivity](https://arxiv.org/abs/2608.02665)
...
### [131] [Internalising the Identity Primitive: Cryptographic Individuality for an Autonomous Agent on a Public Blockchain](https://arxiv.org/abs/2608.02986)
*Keisuke Suzuki*
...
### [132] [Vulnerabilities, Secrets and Misconfiguration in the Highest-Exposure Docker Hub Images](https://arxiv.org/abs/2608.02669)
...
### [133] [Permission Denied: Policy-Graded Evaluation of Coding Agents in Hardened Environments](https://arxiv.org/abs/2608.02670)
...
### [134] [On the Performance of Malware Detection Classifiers Using Hardware Performance Counters](https://arxiv.org/abs/2608.02671)
...
### [135] [Security-First Evaluation of Text-to-Terraform: Benchmarking LLMs and SLMs for Secure IaC Generation](https://arxiv.org/abs/2608.02672)
...
### [136] [Moving the Safety Barrier: Dynamic Routing Adaptive Alignment Against White-Box Attacks](https://arxiv.org/abs/2608.02674)
...
### [137] [DenialRAG: Single-Document RAG Poisoning via Embedded Parametric Denial](https://arxiv.org/abs/2608.02678)
...
### [138] [Safety in Batches? Understanding and Mitigating Safety Failures in Batch Prompting](https://arxiv.org/abs/2608.02681)
...
### [139] [$S^3$: Improving Agent Safety through Multi-Stage Defense](https://arxiv.org/abs/2608.02683)
...
### [140] [PolicyGuard: Prompt-Configurable Semantic DLP for LLM Coding Agents](https://arxiv.org/abs/2608.02687)
...
### [141] [Stylometric Defenses Against Author Impersonation in Software Repositories](https://arxiv.org/abs/2608.02695)
...
### [142] [Steganalysis of Adaptive Covert Collusion in Tool-Using Agent Populations: A Black-Box, Cross-Principal Approach](https://arxiv.org/abs/2608.02698)
...
### [143] [Privacy-Preserving AI Verification via Minimal Information Disclosure](https://arxiv.org/abs/2608.02774)
...
### [144] [Fast Object Removal Attacks on Safety-Critical Video-based Perception Systems](https://arxiv.org/abs/2608.02806)
...
### [145] [Evading Chain-of-Thought Monitoring Through Model Poisoning](https://arxiv.org/abs/2608.02820)
...
### [146] [What the Detector Can See: Evaluating CPS Anomaly Detectors Independently of the Decision Rule](https://arxiv.org/abs/2608.02821)
...
### [147] [Decidability of Parameterised Dolev-Yao Secrecy](https://arxiv.org/abs/2608.02838)
...
### [148] [MutMem: Cryptographically Authorized Mutation in Persistent Agent Memory](https://arxiv.org/abs/2608.02843)
*Walid Saidi*
...
### [149] [SparSEEty: Extracting Tokens from Sparsity-Exploiting LLM Serving Systems via Deterministic Side Channels](https://arxiv.org/abs/2608.02995)
...
### [150] [Tiny Enough to Break In: Agentic Remote Access Trojans Powered by Small Language Models](https://arxiv.org/abs/2608.03009)
...
### [151] [AI Security Leaderboard: Methodology, Results and Minimal Standard](https://arxiv.org/abs/2608.03070)
...
### [152] [DHMark: Public-Key Watermarking for LLM-Generated Text via Diffie-Hellman-Guided Rejection Sampling](https://arxiv.org/abs/2608.03093)
...
### [153] [FakeI2V-Bench: Benchmarking the Applicability of Image-level Deepfake Detectors for Deepfake Video Detection](https://arxiv.org/abs/2608.03096)
...
### [154] [PECR: A Reproducible Specification and Synthetic Stress Test of Telemetry-Informed Vulnerability Prioritization for SD-WAN](https://arxiv.org/abs/2608.03110)
*Saeed Alam*
...
### [155] [DP-MemView: A Memory Interface for Attribute-Level Transcript Privacy in Long-Term LLM Agents](https://arxiv.org/abs/2608.03130)
...
### [156] [CLEAR: Causal Context-Based Agentic Reasoning for Vulnerability Detection](https://arxiv.org/abs/2608.03134)
...
### [157] [AirKey: Multimodal Acoustic-Assisted WiFi Sensing for Zero-Training Robust PIN Inference](https://arxiv.org/abs/2608.03151)
...
### [158] [SpreadMark: Robust Image Watermarking via Spread-Spectrum Embedding](https://arxiv.org/abs/2608.03165)
...
### [159] [Test-time reasoning effort and unauthorized tool use in language-model agents: a prespecified equivalence study](https://arxiv.org/abs/2608.03169)
...
### [160] [Attribute-based Undetectable Watermarking for Generative AI Models](https://arxiv.org/abs/2608.03174)
...
### [161] [MalTotal: Cost-Effective and Language-Agnostic Malicious Code Poisoning Detection for Millions of Repositories](https://arxiv.org/abs/2608.03232)
...
### [162] [ShielDroid: A Hybrid Approach Integrating Machine and Deep Learning for Android Malware Detection](https://arxiv.org/abs/2608.03250)
...
### [163] [FedGSA: Geometry-Consistent Subspace Aggregation for Differentially Private Federated LoRA](https://arxiv.org/abs/2608.03267)
...
### [164] [Breaking ACDGV MinRank Gabidulin encryption schemes over matrix codes](https://arxiv.org/abs/2608.03328)
*Thai Hung Le*
...
### [165] [SkillSentry: Adaptive Honey Worlds for Dynamic Safety Testing of Agent Skills](https://arxiv.org/abs/2608.03485)
...
### [166] [SkillJack: Persistent Skill Backdoors in Self-Evolving Agents](https://arxiv.org/abs/2608.03509)
...
### [167] [AI Forensics Across White-, Grey-, and Black-Box Access: A Process Model and Research Agenda for Post-Incident Investigation of AI Systems](https://arxiv.org/abs/2608.03520)
...
### [168] [A Challenge-Nonce Freshness Gap in Project Veraison's TPM Reference Schemes, Found by Appraising Application-Layer Action Evidence End-to-End](https://arxiv.org/abs/2608.03534)
*Anton Sokolov*
...
### [169] [ReputationChain: Robust Trust Updating for Blockchain-Enabled Supply Chains](https://arxiv.org/abs/2608.03554)
...
### [170] [CAN Disabler: Hardware-based Prevention method of Unauthorized Transmission in CAN and CAN-FD networks](https://arxiv.org/abs/2608.03567)
...
### [171] [Secure Long-Range Autonomous Valet Parking: A Reservation Scheme With Three-Factor Authentication and Key Agreement](https://arxiv.org/abs/2608.03590)
...
### [172] [DiagChain: A Diagnostic Benchmark for Evaluating LLM Agents on Evidence-Grounded Attack Chain Reconstruction](https://arxiv.org/abs/2608.03591)
...
### [173] [A Security-Oriented Lifecycle Model for Large Language Model Systems](https://arxiv.org/abs/2608.03626)
...
### [174] [Empirical Analysis of Evasion and Poisoning Against Malware Data Drift Detection](https://arxiv.org/abs/2608.03642)
...
### [175] [When Agents Learn to Be You: Benchmarking Privacy Leakage, Impersonation Risk, and Defenses in Persona Skills](https://arxiv.org/abs/2608.03700)
...
### [176] [Dependency Triad: A Metric to Quantify the Dependencies Between Attributes for Local Differential Privacy](https://arxiv.org/abs/2608.03737)
...
### [177] [Delay Attacks on the German Smart Metering Infrastructure: A Security Analysis of CLS Channel Timing Constraints](https://arxiv.org/abs/2608.03751)
